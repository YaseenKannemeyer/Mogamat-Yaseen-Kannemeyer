...
export function ContactForm() {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm prose-invert max-w-none min-h-[130px] px-3.5 py-3 text-sm text-neutral-200 focus:outline-none",
      },
    },
  });
    ...
    <div className="relative mx-auto w-full max-w-xl overflow-hidden rounded-2xl border border-white/8 bg-[#0d0d0d] shadow-2xl shadow-black/70">
      ...
      <form onSubmit={handleSend} className="relative space-y-4 px-7 py-6">
        ...
        <button
          ...
          className={cn(
            "flex h-10 w-full items-center justify-center gap-2 rounded-lg text-sm font-semibold tracking-wide transition-all duration-200 active:scale-[0.99]",
            sent === "done"

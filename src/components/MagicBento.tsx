...
const MagicBento: React.FC<BentoProps> = ({
    ...
    <>
      <style>
        {`
          ...
          .card-responsive {
  grid-template-columns: repeat(4, 1fr); /* fewer columns → bigger cards */
  width: 95%; /* expand container width */
  max-width: 90rem; /* optional, control max width */
  margin: 0 auto;
}
 ...
 const baseClassName = `card flex flex-col justify-between relative aspect-[16/9] min-h-[300px] w-full max-w-[600px] p-10 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${enableBorderGlow ? 'card--border-glow' : ''}`;
